...
public class SaborService {
    ...
    public Optional<SaborDTO> findById(Long id) {
        return saborRepository.findById(id).map(SaborDTO::new);
    }
    ...
    @Transactional(readOnly = true)
    public List<SaborDTO> findByDiaRegistro(LocalDate registro){
    ...
    @Transactional(readOnly = true)
    public List<SaborDTO> findByDiaAtualizar(LocalDate atualizar){
